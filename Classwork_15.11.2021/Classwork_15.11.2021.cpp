...
int main() {
	...
	fill2DArrayDiag1(d, rows, cols);//4)Инициализация 2-массива с 1 на главной диагонали и 0 в остальных элементах.
	...
	swapСolumns(dSwap, Srows, Scols, c1, c2);

	std::cout << "Array after swapping columns :" << std::endl;
	print2Darray(dSwap, Srows, Scols);

	swapСolumns(dSwap, Srows, Scols, c1, c2);//Возвращение массива в исходное состояние
